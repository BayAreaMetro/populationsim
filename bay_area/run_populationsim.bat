...
set URBANSIMPATH=M:\urban_modeling\baus\PBA50Plus\PBA50Plus_FinalBlueprint\PBA50Plus_Final_Blueprint_v65_w_interim_dev_b_prior2
...
set BAUS_RUNNUM=PBA50Plus_Final_Blueprint_v65_w_interim_dev_b_prior2
