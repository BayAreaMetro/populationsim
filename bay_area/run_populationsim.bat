...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Back to the Future (S5)\2019 02 11
set BAUS_RUNNUM=run39
set OUTPUT_SUFFIX=BackToTheFuture_20190211_!BAUS_RUNNUM!
