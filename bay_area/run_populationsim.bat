...
set URBANSIMPATH=M:\urban_modeling\baus\PBA50Plus\PBA50Plus_FinalBlueprint\PBA50Plus_Final_Blueprint_v41
:: used in OUTPUT_SUFFIX as well; use "census" for non-BAUS-based run
set BAUS_RUNNUM=PBA50Plus_Final_Blueprint_v41
:: OUTPUT DIR will be X:\populationsim_outputs\hh_gq\output_!OUTPUT_SUFFIX!_!YEAR!!PUMA_SUFFIX!_!BAUS_RUNNUM!
set OUTPUT_SUFFIX=FBP_20250316
