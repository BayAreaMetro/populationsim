...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Clean and Green (S1)\2019 08 02 PPA v10.1 (pipelinefix + adjustment)
set BAUS_RUNNUM=run19
set OUTPUT_SUFFIX=CleanAndGreen_20190802_!BAUS_RUNNUM!
