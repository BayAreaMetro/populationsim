...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Back to the Future (S5)\2019 04 18 PPA v8
set BAUS_RUNNUM=run65
set OUTPUT_SUFFIX=BackToTheFuture_20190418_!BAUS_RUNNUM!
