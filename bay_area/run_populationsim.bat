...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Clean and Green (S1)\2019 02 11
set BAUS_RUNNUM=run50
set OUTPUT_SUFFIX=CleanAndGreen_20190211_!BAUS_RUNNUM!
