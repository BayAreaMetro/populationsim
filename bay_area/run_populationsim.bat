...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Rising Tides Falling Fortunes (S2)\2019 08 02 PPA v10.1 (pipelinefix + adjustment)
set BAUS_RUNNUM=run18
set OUTPUT_SUFFIX=RisingTides_20190802_!BAUS_RUNNUM!
