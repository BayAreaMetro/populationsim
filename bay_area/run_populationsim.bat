...
set URBANSIMPATH=M:\urban_modeling\baus\PBA50Plus\PBA50Plus_DBP_InitialRun\outputs\PBA50Plus_Draft_Blueprint_v2b
:: used in OUTPUT_SUFFIX as well; use "census" for non-BAUS-based run
set BAUS_RUNNUM=PBA50Plus_Draft_Blueprint_v2b
:: OUTPUT DIR will be X:\populationsim_outputs\hh_gq\output_!OUTPUT_SUFFIX!_!YEAR!!PUMA_SUFFIX!_!BAUS_RUNNUM!
set OUTPUT_SUFFIX=DBP_20240415
