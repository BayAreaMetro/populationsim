...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Rising Tides Falling Fortunes (S2)\2019 08 14 FR1 re-run v1
set BAUS_RUNNUM=run26
set OUTPUT_SUFFIX=RisingTides_20190814_!BAUS_RUNNUM!
