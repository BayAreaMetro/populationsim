...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Clean and Green (S1)\2019 06 13 PPA v9 (no slr)
set BAUS_RUNNUM=run160
set OUTPUT_SUFFIX=CleanAndGreen_20190613_!BAUS_RUNNUM!
