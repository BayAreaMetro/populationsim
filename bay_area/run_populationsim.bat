...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Clean and Green (S1)\2019 03 15 PPA version 6
set BAUS_RUNNUM=run89
set OUTPUT_SUFFIX=CleanAndGreen_20190315_!BAUS_RUNNUM!
