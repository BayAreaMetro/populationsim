...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\Travel Model 2\csvs\2021 09 07
set BAUS_RUNNUM=manualTM2_20210907
set OUTPUT_SUFFIX=manualTM2_20210907
