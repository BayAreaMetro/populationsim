...
set URBANSIMPATH=\\tsclient\C\Users\ftsang\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\PBA50\Draft Blueprint runs\Blueprint Basic (s21)\v1.5.1\v1.5.1.2 (to 2050) manual fix
set BAUS_RUNNUM=run56
set OUTPUT_SUFFIX=PBA50Basic_20200610Fix1_!BAUS_RUNNUM!
