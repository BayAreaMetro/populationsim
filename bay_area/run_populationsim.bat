...
set URBANSIMPATH=\\tsclient\C\Users\ywang\Box\Modeling and Surveys\Urban Modeling\Past Applications\RTP2017\Output\Final Output\r10
set BAUS_RUNNUM=run10
set OUTPUT_SUFFIX=IPA_chk_tazData_20161216_!BAUS_RUNNUM!
