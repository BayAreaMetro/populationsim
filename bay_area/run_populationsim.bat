...
set URBANSIMPATH=\\tsclient\C\Users\ftsang\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Rising Tides Falling Fortunes (S2)\2019 09 09 FR2 v0 iteration 2
set BAUS_RUNNUM=run15
set OUTPUT_SUFFIX=RisingTides_20190909_!BAUS_RUNNUM!
