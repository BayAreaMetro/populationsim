...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim 1.5\Horizon\Output\Clean and Green (S1)\2019 04 18 PPA v8
set BAUS_RUNNUM=run110
set OUTPUT_SUFFIX=CleanAndGreen_20190418_!BAUS_RUNNUM!
