...
set URBANSIMPATH=\\tsclient\C\Users\lzorn\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50\EIR runs\Baseline Large (s25) runs\NP_v8
set BAUS_RUNNUM=run314
set OUTPUT_SUFFIX=PBA50NoProject_20210205_!BAUS_RUNNUM!
