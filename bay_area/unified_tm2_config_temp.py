...
class UnifiedTM2Config:
    ...
    def __init__(self, year=2023, model_type="TM2"):
        ...
        # DATA_DIR and PRIMARY_OUTPUT_DIR for legacy compatibility
        ...
        self.PUMA_RESOLUTION = {
            'enabled': True,
            'method': 'majority_rule',  # or 'manual_override' if you want to use manual_overrides
            'min_threshold_pct': 50,    # percent threshold for majority rule
            'manual_overrides': {}      # e.g., {puma_id: county_id}
        }
    ...
    def _setup_external_paths(self):
        ...
        self.EXTERNAL_PATHS = {
            ...
            # TO DO REMOE I don't know what this is
            'populationsim_update': Path("c:/GitHub/populationsim/bay_area"),
            # Census data cache
    ...
    def get_crosswalk_paths(self):
        """Get paths for crosswalk generation and downstream scripts, including enhanced crosswalk."""
        return {
            ...
            'enhanced_crosswalk': self.CROSSWALK_FILES['enhanced_crosswalk']
        }
    ...
    def get_control_paths(self):
        """Get paths for control generation scripts, including enhanced crosswalk if needed."""
        return {
            'output_dir': self.OUTPUT_DIR,
