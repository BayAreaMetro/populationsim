...
from utils.config_census import GEOGRAPHY_ID_COLUMNS, CENSUS_DEFINITIONS
...
def ensure_geoid_column(df, geography):
    ...
    """
    import logging
    from utils.config_census import GEOGRAPHY_ID_COLUMNS
    ...
    if is_maz_level:
        ...
        if scale_numerator and scale_num_df is not None:
            ...
            if scale_numerator == scale_denominator and control_name.startswith('hh_size_'):
                ...
                from utils.config_census import get_controls_in_category
